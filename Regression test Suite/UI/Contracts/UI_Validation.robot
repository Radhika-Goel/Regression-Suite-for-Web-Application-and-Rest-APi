...
${Username1}      ngcsc1@ngcsc.33mail.com
${Password1}      juniper
...
Super_Tab_Deletion_Validation
    ...
    Sleep    3
    BuiltIn.Sleep    5s
    Selenium2Library.Mouse Over    //div[@id='mCSB_1_container']/li/div/div/ul/li/span[text()='ABCDE']
    Selenium2Library.Click Element    //div[@id='mCSB_1_container']/li/div/div/ul/li/span[text()='ABCDE']
    Selenium2Library.Mouse Over    //div[@id='mCSB_1_container']/li/div/div/ul/li/div/div/ul/li/button/i
    Selenium2Library.Click Element    //div[@id='mCSB_1_container']/li/div/div/ul/li/div/div/ul/li/button/i
    BuiltIn.Sleep    5s
    Selenium2Library.Mouse Over    html/body/div[2]/div/div[1]/div/header
    Selenium2Library.Click Element    html/body/div[2]/div/div[1]/div/section/div[3]/button[2]
    Comment    Input Text    ${Add_Custom_Tab_Window}    ABDCE
    Comment    Sleep    1
    Comment    Click Button    ${Save_Custom_tab_Window}
    Comment    Sleep    3
    Click Element    ${Click_Login_Menu_Link}
    Sleep    3
    Click Element    ${Click_Logout_button}
